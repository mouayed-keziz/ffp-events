    ...
    public function run()
    {
        ...
        \DB::table('event_announcements')->insert(array (
            ...
            array (
                ...
                'visitor_registration_end_date' => '2025-03-26 18:49:44',
                'exhibitor_registration_start_date' => '2025-02-22 18:49:46',
                'exhibitor_registration_end_date' => '2025-03-08 18:49:51',
                ...
                'updated_at' => '2025-03-07 21:57:45',
                'deleted_at' => NULL,
            ),
            1 => 
            array (
                'id' => 2,
                'title' => '{"fr":"SIFFP","en":"SIFFP","ar":"SIFFP"}',
                'description' => '{"fr":"5eme salon international pour le professionnels de la façade, la fenetre et la porte","en":"5eme salon international pour le professionnels de la façade, la fenetre et la porte","ar":"5eme salon international pour le professionnels de la façade, la fenetre et la porte"}',
                'terms' => NULL,
                ...
                'exhibitor_registration_start_date' => '2025-02-04 21:40:49',
                'exhibitor_registration_end_date' => '2025-03-31 21:40:50',
                'website_url' => 'https://gdsc-estin.com',
                'contact' => '{"name":"Mouayed Keziz","email":"m_keziz@estin.dz","phone_number":"0799028574"}',
            'content' => '{"fr":"<p>27 / 09 / 2023</p><p>5eme salon international pour le professionnels de la façade, la fenetre et la porte</p><p>Statut d’inscription</p><p>Non enregistré(e)</p><p>Les inscriptions sont ouvertes jusqu’à</p><p>30 / 08 / 2023</p>","en":"<p>27 / 09 / 2023</p><p>5eme salon international pour le professionnels de la façade, la fenetre et la porte</p><p>Statut d’inscription</p><p>Non enregistré(e)</p><p>Les inscriptions sont ouvertes jusqu’à</p><p>30 / 08 / 2023</p>","ar":"<p>27 / 09 / 2023</p><p>5eme salon international pour le professionnels de la façade, la fenetre et la porte</p><p>Statut d’inscription</p><p>Non enregistré(e)</p><p>Les inscriptions sont ouvertes jusqu’à</p><p>30 / 08 / 2023</p>"}',
                'currencies' => '["EUR","DZD"]',
            ...
            array (
                'id' => 3,
                'title' => '{"fr":"azd","en":"qsd","ar":"qsd"}',
                'description' => '{"fr":"qsd","en":"qsd","ar":"qsd"}',
                'terms' => NULL,
                'start_date' => '2025-03-27 00:09:14',
                'end_date' => '2025-03-26 00:09:15',
                'location' => 'qsd',
                'visitor_registration_start_date' => '2025-03-03 00:09:21',
                'visitor_registration_end_date' => '2025-04-04 00:09:24',
                'exhibitor_registration_start_date' => '2025-02-24 00:09:26',
                'exhibitor_registration_end_date' => '2025-05-10 00:09:27',
                'website_url' => 'https://dz-build.com',
                'contact' => '{"name":"qsd","email":"m_keziz@estin.dz","phone_number":"qsd"}',
                'content' => '{"fr":"<p>azd</p>","en":"<p>qsd</p>","ar":"<p>qsd</p>"}',
                'currencies' => '["DZD","EUR","USD"]',
                'created_at' => '2025-03-07 23:10:11',
                'updated_at' => '2025-03-07 23:54:59',
                'deleted_at' => NULL,
            ),
        ));
