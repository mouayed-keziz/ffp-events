...
return [
    'resource' => [
        ...
        'plural_label' => 'Exhibitor Registrations',
    ],
    'fields' => [
        'status' => 'Status',
    ...
    'modals' => [
        ...
        'accept_description' => 'This will accept the exhibitor registration and create payment slices.',
        'reject' => 'Reject Registration',
        'reject_description' => 'Are you sure you want to reject this exhibitor registration?',
        ...
        'make_ready' => 'Mark Registration as Ready',
        'make_ready_description' => 'This will mark the exhibitor registration as ready. Are you sure you want to continue?',
        'archive' => 'Archive Registration',
        'archive_description' => 'This will archive the exhibitor registration. Are you sure you want to continue?',
        'approve_update' => 'Approve Update Request',
    ...
    'success_messages' => [
        'submission_accepted' => 'Registration accepted successfully',
        'submission_rejected' => 'Registration rejected',
        ...
        'submission_ready' => 'Registration marked as ready',
        'submission_archived' => 'Registration archived successfully',
    ...
    'details' => [
        ...
        'email' => 'Email',
        'status' => 'Status',
        'submission_date' => 'Registration Date',
        'can_edit' => 'Can Edit',
        'prices' => 'Prices',
