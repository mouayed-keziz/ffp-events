...
return [
    ...
    'actions' => [
        ...
        "edit_badge_templates" => "Modifier les modèles de badges",
    ...
    'badge_templates' => [
        ...
        'section_description' => 'Téléchargez des modèles de badges pour différents types de participants',
        'visitor_badge' => 'Modèle de badge visiteur',
        'exhibitor_badge' => 'Modèle de badge exposant',
        'sponsor_badge' => 'Modèle de badge sponsor',
        'upload_requirements' => 'Télécharger une image de modèle de badge',
        'aspect_ratio_hint' => 'L\'image doit avoir les proportions d\'une feuille A4 (orientation portrait)',
        'aspect_ratio_error' => 'L\'image doit avoir les proportions d\'une feuille A4 (orientation portrait)',
        'min_height_error' => 'La hauteur de l\'image doit être d\'au moins 1080 pixels',
    ],
    'empty_states' => [
