...
class ExhibitorPaymentRegistrationAcceptedMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: __('emails/exhibitor-payment-registration-accepted.subject', [
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'mails.exhibitor.exhibitor-payment-registration-accepted',
            with: [
                'event' => $this->event,
