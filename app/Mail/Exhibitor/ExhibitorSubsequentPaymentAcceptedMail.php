...
class ExhibitorSubsequentPaymentAcceptedMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: __('emails/exhibitor-subsequent-payment-accepted.subject', [
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'mails.exhibitor.exhibitor-subsequent-payment-accepted',
            with: [
                'event' => $this->event,
