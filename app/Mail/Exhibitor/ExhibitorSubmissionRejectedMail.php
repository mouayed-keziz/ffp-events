...
class ExhibitorSubmissionRejectedMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: __('emails/exhibitor-submission-rejected.subject', [
    ...
    public function content(): Content
    {
        ...
        return new Content(
            view: 'mails.exhibitor.exhibitor-submission-rejected',
            with: [
                'event' => $this->event,
