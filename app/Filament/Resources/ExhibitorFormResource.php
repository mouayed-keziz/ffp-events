                            ...
                            ->schema([
                                ...
                                ComponentsBuilder::make('fields')
                                    ...
                                    ->blocks([
                                        ...
                                        Components\Ecommerce2Block::make(FormField::ECOMMERCE_2->value, $currencies)
                                            ->icon('heroicon-o-shopping-cart')
                                            ->label(function ($state) {
                                                return FormField::ECOMMERCE_2->getLabel() . (isset($state['label']) && is_array($state['label']) && isset($state['label'][app()->getLocale()]) ? ": " . $state['label'][app()->getLocale()] : '');
                                            }),
