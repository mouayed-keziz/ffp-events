...
class MyEvent extends Model implements HasMedia
{
    ...
    {
        return $this->belongsToMany(User::class, 'event_announcement_user', 'event_announcement_id', 'user_id')
            ->withTimestamps();
    }
    ...
    {
        return $this->hasMany(BadgeCheckLog::class, 'event_announcement_id')
            ->with('checkedByUser')
    ...
    {
        return $this->hasMany(CurrentAttendee::class, 'event_announcement_id')
