...
use App\Mail\Exhibitor\ExhibitorPaymentRegistrationAcceptedMail;
...
class ExhibitorPaymentRegistrationAccepted extends Notification implements ShouldQueue
{
    use Queueable;
     ...
     */
    public function toMail(object $notifiable): ExhibitorPaymentRegistrationAcceptedMail
    {
        return (new ExhibitorPaymentRegistrationAcceptedMail(
            $this->event,
            $notifiable,
            $this->paymentSlice,
            $this->locale
    ...
    public function toArray(object $notifiable): array
    {
        ...
        foreach (['en', 'fr', 'ar'] as $locale) {
            ...
            $translatedMessages[$locale] = __(
                'emails/exhibitor-payment-registration-accepted.confirmation_notice',
        ...
        return [
            ...
            'type' => 'exhibitor_payment_registration_accepted',
