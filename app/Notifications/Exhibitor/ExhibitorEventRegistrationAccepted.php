...
use App\Mail\Exhibitor\ExhibitorEventRegistrationAcceptedMail;
...
class ExhibitorEventRegistrationAccepted extends Notification implements ShouldQueue
{
    use Queueable;
     ...
     */
    public function toMail(object $notifiable): ExhibitorEventRegistrationAcceptedMail
    {
        return (new ExhibitorEventRegistrationAcceptedMail(
            $this->event,
            $notifiable,
            $this->submission,
            $this->locale
    ...
    public function toArray(object $notifiable): array
    {
        ...
        foreach (['en', 'fr', 'ar'] as $locale) {
            ...
            $translatedMessages[$locale] = __('emails/exhibitor-event-registration-accepted.acceptance_info', [], $locale);
        }
        ...
        return [
            ...
            'type' => 'exhibitor_event_registration_accepted',
