...
use App\Mail\Exhibitor\ExhibitorSubsequentPaymentRejectedMail;
...
class ExhibitorSubsequentPaymentRejected extends Notification implements ShouldQueue
{
     ...
     */
    public function toMail(object $notifiable): ExhibitorSubsequentPaymentRejectedMail
    {
        return (new ExhibitorSubsequentPaymentRejectedMail(
            $this->event,
            $notifiable,
            $this->paymentSlice,
            $this->locale
    ...
    public function toArray(object $notifiable): array
    {
        ...
        foreach (['en', 'fr', 'ar'] as $locale) {
            ...
            $translatedMessages[$locale] = __(
                'emails/exhibitor-subsequent-payment-rejected.rejection_notice',
                ['event_name' => $translatedTitles[$locale]],
                $locale
            );

            // Get translated rejection reason if it exists
            if ($this->paymentSlice->rejection_reason) {
                $translatedReasons[$locale] = $this->paymentSlice->getTranslation('rejection_reason', $locale, false);
            }
        }
        ...
        return [
            ...
            'type' => 'exhibitor_subsequent_payment_rejected',
