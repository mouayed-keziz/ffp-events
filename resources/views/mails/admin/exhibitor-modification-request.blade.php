...
<body
    ...
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">
        Demande de modification de formulaire - {{ $event->title }}
    </div>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        ...
                        Date de la demande: {{ $submission->update_requested_at->format('d/m/Y H:i') }}<br>
                        Événement: {{ $event->title }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        Veuillez consulter le tableau de bord administrateur pour approuver ou refuser cette demande de
                        modification.
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
