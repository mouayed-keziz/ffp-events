...
<body
    ...
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">
        Nouvelle soumission d'exposant - {{ $event->title }}
    </div>
        ...
        <tbody>
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        <strong>Détails de la soumission:</strong><br>
                        Nom de l'exposant: {{ $exhibitor->name }}<br>
                        Email: {{ $exhibitor->email }}<br>
                        Date de soumission: {{ $submission->created_at->format('d/m/Y H:i') }}<br>
                        Événement: {{ $event->title }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        Veuillez consulter le tableau de bord administrateur pour examiner et traiter cette demande.
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
