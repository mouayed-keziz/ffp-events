...
<body
    ...
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">
        Badges d'exposant mis à jour - {{ $event->title }}
    </div>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <h1
                        ...
                        Badges d'exposant mis à jour
                    </h1>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        Bonjour {{ $admin->name ?? 'Administrateur' }},
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        L'exposant <strong>{{ $exhibitor->name }}</strong> a mis à jour ses badges pour l'événement
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        ...
                        Date de mise à jour: {{ now()->format('d/m/Y H:i') }}<br>
                        Événement: {{ $event->title }}<br>
                        Nombre de badges: {{ $badges->count() }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        Veuillez consulter le tableau de bord administrateur pour examiner les badges mis à jour.
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
