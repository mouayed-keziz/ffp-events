...
<head>
    ...
    <title>
        {{ __('emails/exhibitor-edit-submission-request-rejected.subject', ['event_name' => $event->getTranslation('title', $locale)]) }}
    </title>
</head>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.greeting', ['exhibitor_name' => $exhibitor->name]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.intro', ['event_name' => $event->getTranslation('title', $locale)]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.details') }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.event_name', ['event_name' => $event->getTranslation('title', $locale)]) }}<br>
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.explanation') }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {!! __('emails/exhibitor-edit-submission-request-rejected.reasons') !!}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.contact') }}
                    </p>
                    <hr
                    ...
                    <p style="color:rgb(102,102,102);font-size:12px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-edit-submission-request-rejected.salutation') }}<br />
                        {{ __('emails/exhibitor-edit-submission-request-rejected.team') }}
                    </p>
                </td>
            </tr>
        </tbody>
