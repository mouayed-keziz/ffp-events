...
<head>
    ...
    <title>
        {{ __('emails/exhibitor-subsequent-payment-rejected.subject', ['event_name' => $event->getTranslation('title', $locale)]) }}
    </title>
</head>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-subsequent-payment-rejected.greeting', ['exhibitor_name' => $exhibitor->name]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-subsequent-payment-rejected.intro', ['event_name' => $event->getTranslation('title', $locale)]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-subsequent-payment-rejected.payment_details') }}
                    </p>
                    <ul style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0;padding-left:24px;">
                        ...
                        @endphp
                        <li>{{ __('emails/exhibitor-subsequent-payment-rejected.amount', [
                            'amount' => $paymentSlice->price,
                            'currency' => $paymentSlice->currency,
                        ]) }}
                        </li>
                        <li>{{ __('emails/exhibitor-subsequent-payment-rejected.date', [
                            'date' => $uploadDate ? $uploadDate->format('d/m/Y') : '-',
                        ]) }}
                        </li>
                        <li>{{ __('emails/exhibitor-subsequent-payment-rejected.status') }}</li>
                        </li>
                    </ul>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-subsequent-payment-rejected.instructions') }}
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-subsequent-payment-rejected.assistance') }}
                    </p>
                    <hr
                    ...
                    <p style="color:rgb(102,102,102);font-size:12px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-subsequent-payment-rejected.regards') }}<br />
                        {{ __('emails/exhibitor-subsequent-payment-rejected.team') }}
                    </p>
                </td>
            </tr>
        </tbody>
