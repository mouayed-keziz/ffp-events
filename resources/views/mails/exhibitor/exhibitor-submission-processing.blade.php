...
<body
    ...
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">
        {{ __('emails/exhibitor-submission-processing.subject', ['event_name' => $event->title]) }}
    </div>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.greeting', ['name' => $exhibitor->name]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.submission_notice', ['event_name' => $event->title]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.processing_info') }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        <strong>{{ __('emails/exhibitor-submission-processing.participation_details') }}</strong><br>
                        {{ __('emails/exhibitor-submission-processing.event') }} {{ $event->title }}<br>
                        {{ __('emails/exhibitor-submission-processing.date') }} {{ $event->formatted_date }}<br>
                        {{ __('emails/exhibitor-submission-processing.location') }} {{ $event->location }}<br>
                        {{ __('emails/exhibitor-submission-processing.status') }}
                        {{ __('emails/exhibitor-submission-processing.status_pending') }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.review_notice') }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.payment_instruction') }}
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <td>
                                    <a href="{{ route('event_details', ['id' => $event->id]) }}"
                                        ...
                                        target="_blank"><span><!--[if mso]><i style="mso-font-width:500%;mso-text-raise:18" hidden>&#8202;&#8202;</i><![endif]--></span><span
                                            style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">{{ __('emails/exhibitor-submission-processing.event_page_link') }}</span><span><!--[if mso]><i style="mso-font-width:500%" hidden>&#8202;&#8202;&#8203;</i><![endif]--></span></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.questions') }}
                    </p>
                    <hr
                    ...
                    <p style="color:rgb(102,102,102);font-size:12px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-submission-processing.regards') }}<br />
                        {{ __('emails/exhibitor-submission-processing.team') }}
                    </p>
                </td>
            </tr>
        </tbody>
