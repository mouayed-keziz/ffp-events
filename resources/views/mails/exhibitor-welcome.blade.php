...
<body
    ...
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">
        {{ __('emails/exhibitor-welcome.subject') }}
    </div>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-welcome.greeting', ['name' => $name]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-welcome.account_created') }}
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        role="presentation" style="margin-top:32px;margin-bottom:32px">
                        <tbody>
                            <tr>
                                <td>
                                    <div style="background-color:#f3f4f6;border-radius:0.25rem;padding:16px">
                                        <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:0 0 8px 0">
                                            <strong>{{ __('emails/exhibitor-welcome.email_label') }}</strong>:
                                            {{ $email }}
                                        </p>
                                        <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:0">
                                            <strong>{{ __('emails/exhibitor-welcome.password_label') }}</strong>:
                                            {{ $password }}
                                        </p>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('login') }}"
                                        ...
                                        target="_blank"><span><!--[if mso]><i style="mso-font-width:500%;mso-text-raise:18" hidden>&#8202;&#8202;</i><![endif]--></span><span
                                            style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">{{ __('emails/exhibitor-welcome.login_button') }}</span><span><!--[if mso]><i style="mso-font-width:500%" hidden>&#8202;&#8202;&#8203;</i><![endif]--></span></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-welcome.password_change') }}
                    </p>
                    <hr
                    ...
                    <p style="color:rgb(102,102,102);font-size:12px;line-height:24px;margin:16px 0">
                        {{ __('emails/exhibitor-welcome.regards') }}<br />
                        {{ __('emails/exhibitor-welcome.team') }}
                    </p>
                </td>
            </tr>
        </tbody>
