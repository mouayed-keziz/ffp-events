...
<body
    ...
    <div style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">
        {{ __('emails/change-email.subject') }}
    </div>
            ...
            <tr style="width:100%">
                <td>
                    ...
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/change-email.greeting', ['name' => $name]) }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/change-email.request_info') }}
                    </p>
                    <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="{{ route('verify-email-change') }}?token={{ $token }}&user={{ $model }}"
                                        ...
                                        target="_blank"><span><!--[if mso]><i style="mso-font-width:500%;mso-text-raise:18" hidden>&#8202;&#8202;</i><![endif]--></span><span
                                            style="max-width:100%;display:inline-block;line-height:120%;mso-padding-alt:0px;mso-text-raise:9px">{{ __('emails/change-email.confirm_link') }}</span><span><!--[if mso]><i style="mso-font-width:500%" hidden>&#8202;&#8202;&#8203;</i><![endif]--></span></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/change-email.expiry_info') }}
                    </p>
                    <p style="color:rgb(0,0,0);font-size:14px;line-height:24px;margin:16px 0">
                        {{ __('emails/change-email.not_requested') }}
                    </p>
                    <hr
                    ...
                    <p style="color:rgb(102,102,102);font-size:12px;line-height:24px;margin:16px 0">
                        {{ __('emails/change-email.regards') }}<br />
                        {{ __('emails/change-email.team') }}
                    </p>
                </td>
            </tr>
        </tbody>
