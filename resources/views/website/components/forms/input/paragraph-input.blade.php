...
<div class="form-control">
    ...
    <textarea @if ($disabled) disabled @endif
        ...
        class="textarea textarea-bordered bg-white mb-2 rounded-md {{ app()->getLocale() === 'ar' ? 'pr-[10px]' : 'pl-[10px]' }}"
        wire:model.lazy="formData.{{ $answerPath }}" @if ($data['required'] ?? false) required @endif></textarea>
</div>
