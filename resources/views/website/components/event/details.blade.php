    ...
    <div class="space-y-6">
        <div class="bg-white rounded-xl shadow-lg p-6 space-y-6">
            ...
            <div class="flex gap-2">
                ...
                <div>
                    <h3 class="text-neutral-600 mb-2">{{ __('website/event.event_date') }}</h3>
                    <p class="font-bold">
            ...
            <div class="flex gap-2">
                ...
                <div>
                    <h3 class="text-neutral-600 mb-2">{{ __('website/event.location') }}</h3>
            ...
            <div class="flex gap-2">
                @include('website.svg.event.callendar')
                <div>
                    <h3 class="text-neutral-600 mb-2">{{ __('website/event.exhibitor_registration_date') }}</h3>
                    <p class="font-bold">
            ...
            <div class="flex gap-2">
                @include('website.svg.event.callendar')
                <div>
                    <h3 class="text-neutral-600 mb-2">{{ __('website/event.visitor_registration_date') }}</h3>
                    <p class="font-bold">
            ...
            <div class="flex gap-2">
                ...
                <div>
                    <h3 class="text-neutral-600 mb-2">{{ __('website/event.website') }}</h3>
                    <a href="{{ $event['website_url'] }}" target="_blank" class="font-bold hover:text-primary">
                        {{ $event['website_url'] }}
                    </a>
                </div>
            </div>
            ...
            <div class="flex gap-2">
                ...
                <div>
                    <h3 class="text-neutral-600 mb-2">{{ __('website/event.project_manager_contact') }}</h3>
                    <div class="space-y-1">
