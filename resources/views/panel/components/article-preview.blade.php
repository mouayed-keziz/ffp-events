...
{{-- <x-filament::section> --}}
    ...
    @if ($hasImage)
    <div class="shadow" style="position: relative; width: 100%; aspect-ratio: 16/9; border-radius: 0.5rem; overflow: hidden;">
        <img src="{{ $imageUrl }}" alt="{{ $getRecord()->title }}" style="width: 100%; height: 100%; object-fit: cover;">
    </div>
    <br/><br/>
    @else
        <p class="text-lg text-gray-500 dark:text-gray-400">{{ __('articles.empty_states.image') }}</p>
      <br/>
        @endif
